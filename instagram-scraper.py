...
def scrape_instagram_tag(tag: str, total_count: int, existing: set=None):
    ...
    url = f'https://www.instagram.com/{tag}/tagged'
    ...
    while count <= total_count:
        ...
        req.html.render(wait=1, scrolldown=page)
        images = req.html.xpath('//img[@alt]')
        # images = req.html.xpath('//a[@href]')
...
def scrape_instagram(tags: List[str], total_count: int, existing: set=None):
...
for url, caption, hashtags, mentions in scrape_instagram(['espol1'], 5):
